...
app = Flask(__name__,template_folder="/home/aulasfamigti/mysite/templates")
...
def previsao_iris(lista_valores_formulario):
    ...
    modelo_salvo = joblib.load('/home/aulasfamigti/mysite/modelo_knn.joblib')             #realiza a carga do modelo salvo
